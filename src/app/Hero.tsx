...
export default function Hero() {
    return (
        <div className="my-container mx-auto">
            <div className="relative pt-[64px] mb-20 lg:mb-40">
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col h-[280px] lg:h-[380px]">
                        ...
                        <div className="flex justify-center items-center space-x-10 xl:space-x-14 group lg:justify-start lg:pl-20">
                            ...
                            <div className="relative w-max">
                                ...
                                <div className="w-13 h-13 xl:w-16 xl:h-16 rounded-full relative overflow-hidden">
                                    <div
                                        ...
                                        <div className="w-11 h-11 xl:w-13 xl:h-13 absolute bg-[#FDFBF8] rounded-full"></div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="">
                <div className="container mx-auto px-4">
                    <div className={`${sora.className} text-center text-xl lg:text-4xl mb-5 lg:mb-18`}>More Than Just Cakes</div>
                    <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-40 xl:gap-70 space-y-6">
                        <div className="w-full border-t-2 border-black relative">
                            <div className="absolute w-3 h-3 rounded-full -top-[7px] right-0 bg-black"></div>
                            <h6 className={`${sora.className} py-2 text-md font-extralight lg:text-2xl`}>Reliable, Same-Day
                                Delivery</h6>
                        ...
                        <div className="w-full border-t-2 border-black relative">
                            <div className="absolute w-3 h-3 rounded-full -top-[7px] right-0 bg-black"></div>
                            <h6 className={`${sora.className} py-2 text-md font-extralight lg:text-2xl`}>Honest Ingredients</h6>
