...
`,
        ...
        <p>This policy was last updated on 22 of February 2026 </p>
      `,
        }
    ];
    ...
    return (
        <div className="container mx-auto px-4 pt-28">
            <div className="main-block-color py-8 rounded-lg">
                <div className={`${manrope.className} text-center text-xl sm:text-2xl lg:text-3xl xl:text-4xl mb-8`}>
                    Privacy Policy
                </div>
                <div className={`${manrope.className} max-w-[950px] mx-auto space-y-2 pt-10`}>
                    <div className="mb-4 text-sm sm:text-md md:text-lg">
                        Koşi Bakery is the trading name of CAKESJANDK Limited, a UK registered company (company number
                        15369008), whose registered office address is:
                    </div>
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-md xl:text-lg">
                            Personal data refers to any information that may be used to identify you, such as, your
                            name, title, phone number, email address, or mailing address. In general, you can browse our
                            website without giving us any personal information. We use several products to analyse
                            traffic to this website in order to understand our visitors' needs and to continually
                            improve our site for them. We collect only anonymous, aggregate statistics.
                        </p>
                        <p className="text-md xl:text-lg">
                            However, there are additional activities on our site that require you to be registered. For
                            example, to receive our newsletter or purchase products from our store. As part of the
                            registration process, we collect personal information. We use that information for a couple
                            of reasons: to tell you about what you asked us to tell you about, to fulfil your online
                            order, to contact you if we need to obtain or provide additional information, to check our
                            records are right.
                        </p>
                    </div>
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-md xl:text-lg">
                            ...
                            computer's hard disk for certain features of the website to function (such as user accounts
                            in our shop) and allows us to analyse our site traffic patterns. It does not give us access
                            to your computer or to information beyond what you provide us. Most web browsers
                            automatically accept cookies; consult your browser's manual or online help if you want
                            information on restricting or disabling the browser's handling of cookies. If you disable
                            cookies, you can still view the publicly available information on our website although this
                            may affect your user experience. If you are using a shared computer and you have cookies
                            turned on, be sure to log off when you finish to further protect your personal information.
                        </p>
                    </div>
