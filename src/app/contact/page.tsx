    ...
    return (
        <div className="my-container mx-auto pt-24">
            <div className="container mx-auto px-4">
                <div className="main-block-color my-8 p-6 rounded-lg">
                    <div className="flex flex-col justify-center items-center py-4">
                        <h6 className={`${sora.className} mb-4 font-bold text-2xl md:text-3xl lg:text-5xl`}>
                            Contact Us
                        </h6>
                        <p
                        ...
                        <div className="flex flex-col xl:flex-row xl:space-x-6 space-y-4 py-8">
                            ...
                            <div className="space-y-2 xl:w-1/2">
                                ...
                                <form
                                    ...
                                    className="space-y-6 md:h-64 md:flex md:flex-col justify-between pt-5"
                                >
                                    <input
                                        type="text"
                                        name="name"
