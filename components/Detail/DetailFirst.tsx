...
const DetailFirst = () => {
  ...
  return (
        <div className={`${sora.variable} font-main relative`}>
            ...
            <Image src={product.images[0]} alt='img' width={420} height={10} className='absolute w-30 sm:w-50 sm:top-15 sm:right-15 right-3 top-40 lg:w-[300px]  xl:w-[450px] xl:right-20 xl:top-30 '/>
